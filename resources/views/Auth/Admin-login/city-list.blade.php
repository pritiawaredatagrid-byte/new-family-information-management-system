...
<body class="bg-gray-100 font-sans">
    ...
    <div class="page-wrapper">
        <header class="main-header">
            ...
            <div style="width: 50%;">
                <form action="{{ route('redirect-search', ['type' => 'city']) }}" method="GET" class="search">
    <input type="text" name="search" value="{{ $search ?? '' }}" placeholder="Search City">
    <button type="submit">
        ...
        <div class="p-6">
 <div class="bg-white rounded-xl shadow" id="cityTableWrapper">
                @include('Auth.Admin-login.city-table')
            </div>
    ...
    if (target && target.closest('.pagination')) {
        ...
        .then(data => {
            document.getElementById('cityTableWrapper').innerHTML = data;
        })
        .catch(error => {
