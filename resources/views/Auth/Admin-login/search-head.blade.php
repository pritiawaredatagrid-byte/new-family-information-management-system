    ...
    <button type="submit">
        ...
        <div class="p-6">
            ...
            <div class="bg-white rounded-xl shadow" id="familySearchTableWrapper">
                @include('Auth.Admin-login.searchHead-table')
            </div>
...
@endif
  ...
  <script>
    ...
    searchForm.addEventListener('submit', function (e) {
        ...
        fetch(`{{ route('redirect-search', ['type' => 'head']) }}?search=${encodeURIComponent(searchQuery)}`, {
    headers: {
        ...
        .then(html => {
            const wrapper = document.getElementById('familySearchTableWrapper');
            if (wrapper) {
