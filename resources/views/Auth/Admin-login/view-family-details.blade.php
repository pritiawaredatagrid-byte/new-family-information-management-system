    ...
    <div class="page-wrapper">
        ...
        <header class="main-header">
            ...
            <div class="flex items-center space-x-4">
               <a href="{{ '/add-family-member/' . $head->id }}" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-md transition duration-300">
                    Add Family Member
                </a>
            </div>
        </header>
                ...
                <table class="w-full text-sm text-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-3 py-3 truncate max-w-[150px] text-left">{{ $head->address ?? '-' }},<br>{{ $head->state ?? '-' }},<br>{{ $head->city ?? '-' }},<br>{{ $head->pincode ?? '-' }}</td>
