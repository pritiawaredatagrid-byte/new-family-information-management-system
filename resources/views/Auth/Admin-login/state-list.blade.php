...
<body class="bg-gray-100 font-sans">
    ...
    <div class="page-wrapper">
        <header class="main-header">
            ...
            <div style="width: 50%;">
                <form action="{{ route('redirect-search-state', ['type' => 'state']) }}" method="GET" class="search">
    <input type="text" name="search" value="{{ $search ?? '' }}" placeholder="Search State">
    <button type="submit">
        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f">
            ...
            <div class="p-6">
    <div class="bg-white rounded-xl shadow" id="stateTableWrapper">
                @include('Auth.Admin-login.state-table')
            </div>
