...
<head>
    ...
    <link rel="stylesheet" href="/css/search-member.css">
</head>
...
<body class="bg-gray-100 font-sans">
    ...
    <button type="submit">
        ...
        <div class="p-6">
            ...
            <div class="bg-white rounded-xl shadow" id="memberSearchTableWrapper">
                @include('Auth.Admin-login.searchMember-table')
            </div>
